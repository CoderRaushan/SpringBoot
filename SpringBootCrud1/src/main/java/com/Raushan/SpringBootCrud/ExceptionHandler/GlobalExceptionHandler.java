...
import com.Raushan.SpringBootCrud.dto.ExceptionResponseDto;
import com.Raushan.SpringBootCrud.dto.ValidationExceptionResponseDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponseDto>
    handleDuplicateResourceException(DuplicateResourceException ex, HttpServletRequest request)
    {
        ExceptionResponseDto exceptionResponseDto= new ExceptionResponseDto(
                LocalDateTime.now(),
